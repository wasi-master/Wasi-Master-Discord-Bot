...
async def servers(ctx):
    	...
    	await ctx.send(f"I\'m in {servers:3,} servers and there are {members:3,} members total d there are {members:3,} members total and {average}  on average in each server")
