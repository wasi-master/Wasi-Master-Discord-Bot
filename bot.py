...
async def servers(ctx):
    	...
    	await ctx.send(f"I\'m in {servers} servers and there are {members} members total d there are {members} members total and {average} members on average in each server")
